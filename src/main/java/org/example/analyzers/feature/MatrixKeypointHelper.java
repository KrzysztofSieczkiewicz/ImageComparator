...
public class MatrixKeypointHelper {
    ...
    public void detectKeypoints(float[][][][] dogPyramid) {
        ...
        // TODO: Find beter substitution for KeypointCandidate, Keypoint. Too many steps to cover and final Keypoint should remain rather lightweight with only locations, orientation and decriptor
