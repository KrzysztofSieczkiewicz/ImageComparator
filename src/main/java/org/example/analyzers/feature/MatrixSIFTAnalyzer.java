...
public class MatrixSIFTAnalyzer {
    ...
    public void constructScaleSpace(BufferedImage image) {
        ...
        int[][] imageData = ImageDataUtil.getImageData(greyscaleImage);
        ...
        int[][][][] gaussianPyramid = helper.buildGaussianPyramid(imageData, octavesAmount, scalesAmount, downsamplingFactor);
